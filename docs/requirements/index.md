...
The following kinds of documents were intentionally removed from the active
requirements set:
...
reintroduced into one of the authoritative documents above instead of restoring
the old file wholesale.
